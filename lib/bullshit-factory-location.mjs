...
export const LOCATION_SPECS = Object.freeze({
  ...
  [ORANGE_IDIOT_STANDALONE_SCENE_ID]: sceneSpec(
    ...
    },
    {
      ...
      broadcastAnchors: {
        orangeIdiot: {
          // The Orange broadcast is a locked south-facing performance. The
          // renderer may translate the sprite, but it must never rotate it to
          // a side view while the character is speaking.
          centerX: 192,
          leftX: 98,
          rightX: 286,
          spriteWidth: 64,
          ...
          // This foreground podium also masks the source figure that is
          // baked into the supplied house background. It stays in the shot
          // while Orange paces and gives the center position a clear return
          // point without changing the authored scene file.
          podium: {
            left: 158,
            top: 143,
            width: 68,
